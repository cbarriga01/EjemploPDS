...
import org.orm.*;
public class ListOrmclasesData {
	...
	public void listTestData() throws PersistentException {
		...
		for (int i = 0; i < length; i++) {
			System.out.println(ormEspecialidads[i].getNombre());
		}
		System.out.println(length + " record(s) retrieved.");
	...
	public static void main(String[] args) {
		try {
			ListOrmclasesData listOrmclasesData = new ListOrmclasesData();
			try {
				listOrmclasesData.listTestData();
				//listOrmclasesData.listByCriteria();
			}
			finally {
