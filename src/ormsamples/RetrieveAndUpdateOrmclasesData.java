...
import org.orm.*;
public class RetrieveAndUpdateOrmclasesData {
	...
	public static void main(String[] args) {
		try {
			RetrieveAndUpdateOrmclasesData retrieveAndUpdateOrmclasesData = new RetrieveAndUpdateOrmclasesData();
			try {
				retrieveAndUpdateOrmclasesData.retrieveAndUpdateTestData();
				//retrieveAndUpdateOrmclasesData.retrieveByCriteria();
			}
			finally {
