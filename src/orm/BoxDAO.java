...
public class BoxDAO {
	...
	public static boolean save(orm.Box box) throws PersistentException {
		try {
			orm.OrmclasesPersistentManager.instance().saveObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Box box) throws PersistentException {
		try {
			orm.OrmclasesPersistentManager.instance().deleteObject(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Box box) throws PersistentException {
		try {
			orm.OrmclasesPersistentManager.instance().getSession().refresh(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Box box) throws PersistentException {
		try {
			orm.OrmclasesPersistentManager.instance().getSession().evict(box);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
